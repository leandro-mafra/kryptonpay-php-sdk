...
class KryptonPay
{
    ...
    public static function allSubContractById(ApiContext $apiContext, $idContractFather, $idContract, $paramsString = '')
    {
        $api = new Client($apiContext, 'GET', 'contracts/' . $idContractFather . '/subcontracts/' . $idContract . $paramsString);
        return $api->call();
    }
